...
with DAG(
    dag_id="weather_kafka_spark_dag",
    ...
    kafka_stream_task = PythonOperator(
        task_id="weather_data_stream",
        python_callable=stream,
        dag=dag,
    )

    spark_stream_task = DockerOperator(
        task_id="pyspark_weather_consumer",
        image="weather/spark:latest",  # Atualize para a imagem Docker correta se necessário
        api_version="auto",
        auto_remove=True,
